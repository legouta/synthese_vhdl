...
string synth_bis(tree<string> &tr, tree<string>::iterator &a, string &path_signaux_interm, string &path_portes_interm, list<string> &portes_util, 
        list<string> &liste_nom,list<string> &liste_type, list<string> &liste_taille, string destination)
{
    string  source_a, source_b, operateur, type_source_a, taille_source_a;
